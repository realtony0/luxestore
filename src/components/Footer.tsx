...
const WHATSAPP = "8619706419469";
const CONTACT_EMAIL = "Sandralassanah19@gmail.com";
const SITE_NAME = "Luxe Store";
const SITE_SLOGAN = "Streetwear curated selection for a global audience.";
const SITE_ADDRESS = "Worldwide online store";
          ...
          <section className="text-center">
            ...
            <p className="mt-2">
              <a
                ...
                className="rounded text-sm text-white/85 transition hover:text-[var(--accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface-dark)]"
              >
                {CONTACT_EMAIL}
              </a>
            </p>
