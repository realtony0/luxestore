  ...
  if (!hydrated) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-12">
        <h1 className="font-heading text-2xl font-semibold tracking-tight text-[var(--foreground)] sm:text-3xl">Cart</h1>
        <p className="mt-2 text-[var(--muted)]">Loading cart...</p>
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
      ...
      <div className="mt-7 grid gap-6 lg:mt-8 lg:grid-cols-[1.5fr_0.8fr] lg:gap-8">
        ...
        <aside className="h-fit rounded-2xl border border-[var(--border)] bg-[var(--card)] p-4 shadow-sm sm:p-5 lg:sticky lg:top-24">
          <h2 className="font-heading text-xl font-semibold text-[var(--foreground)]">Summary</h2>
