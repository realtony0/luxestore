...
export const metadata: Metadata = {
  title: "Lifestyle",
  description: "Luxe Store lifestyle selection.",
  alternates: {
    canonical: "/univers",
  },
};
    ...
    <div className="min-h-screen bg-white">
      <section className="relative flex min-h-[38svh] items-center justify-center overflow-hidden sm:min-h-[42vh]">
        <div className="absolute inset-0">
          <Image src={heroImage} alt="" fill priority sizes="100vw" className="object-cover brightness-[0.6]" />
